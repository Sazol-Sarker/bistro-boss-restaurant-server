...
– The Bistro Boss Restaurant Team`,
    ...
    // TODO: clear CART/ delete cart data by email?
    app.post("/ssl-payment-success", async (req, res) => {
      ...
      try {
        ...
        if (data?.status === "VALID") {
          ...
          const paymentDoc = await paymentsCollection.findOne(query);
          const cartItemDeleteResult=await cartsCollection.deleteMany({userEmail:paymentDoc.email})
